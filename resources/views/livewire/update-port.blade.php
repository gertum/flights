    ...
    <div class="card-body">
        <form >
            <div class="form-group mb-3">
                ...
                <input type="text" readonly="readonly" class="form-control @error('code') is-invalid @enderror" id="code" placeholder="Enter Code" wire:model="code">
                @error('code')
            ...
            <div class="d-grid gap-2">
                <button wire:click.prevent="updatePort()" class="btn btn-success btn-block">Update</button>
